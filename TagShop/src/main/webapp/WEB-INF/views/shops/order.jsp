	...
	<script type="text/javascript">
 			function check(box){
				if(box.checked == true) {
					...
					var final_price = Number(document.getElementById('total_sum').value) + Number(document.getElementById('deliver_sum').value) -  Number(document.getElementById('usedPoint').value);
					...
					var final_price = Number(document.getElementById('total_sum').value) + Number(document.getElementById('deliver_sum').value) -  Number(document.getElementById('usedPoint').value);
					var final_point = Number(document.getElementById('total_sum').value)*0.001 + Number(document.getElementById('original_point').value);
					document.getElementById('final_price').innerHTML = final_price + " 원";
					document.getElementById('point').value = final_point;
				}
			}	
                            ...
                            <tr class="line-item">
                            	...
                            	<c:forEach var="j" begin="0" end="${OptionList.size()-1}">
	                                ...
	                                <td class="delivery">
	                                    ...
	                                    <label>배송료 ${Itemlist[i].deliveryFee} 원</label>
	                                </td>
	                                ...
	                                <c:set var="DeliverySum" value="${DeliverySum + Itemlist[i].deliveryFee}"></c:set>
                ...
                <div class="col-12 col-md-6">
                    <div class="checkout_details_area mt-50 clearfix">
                        ...
                        <div class="cart-page-heading mb-30">
                            ...
                            <input type="hidden" name="original_point" id="original_point" value="${sessionScope.profileVo.point}">
							...
							<input type="hidden" value="${DeliverySum}" id="deliver_sum">
                    </div>
                    <div class="checkout_details_area mt-50 clearfix">
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="order-details-confirmation">
                        ...
                        <ul class="order-details-form mb-4">
                            ...
                            <li><span>배송비</span> <span>${DeliverySum} 원</span></li>
                            <li><span>포인트 사용</span> <span id="span_point">0원</span></li>
                            <c:set var="FinalSettle" value="${TotalSum + DeliverySum}"></c:set>
						...
						<div class="col-12 mb-3">
                            <c:set var="payTypeList" value="${sessionScope.payTypeList}" ></c:set>
							<select id="payTypeCode" name="payTypeCode" class="form-control">
								<option value="">카드회사를 선택하세요</option>
								<c:forEach var="i" begin="0" end="${payTypeList.size()-1 }">
									<option value="${payTypeList[i].code }">${payTypeList[i].codeName }</option>
								</c:forEach>	
							</select>
                        </div>
