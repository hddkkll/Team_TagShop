				...
				<div class="col-12 col-md-4 col-lg-3">
					<div class="single-product-wrapper-sub">
						<figure class="snip1366">
							<div class="image">
								<img
									src="${pageContext.request.contextPath}/uploads/${productsList[i].photoFile}"
									alt="sample36" />
							</div>
							<figcaption><img src="https://scontent-icn1-1.xx.fbcdn.net/v/t1.0-9/10444787_658035910951116_2981719136649667556_n.jpg?_nc_cat=101&amp;_nc_oc=AQmp1Tw2bRlHq3gCwxMs7fqvtNEml9zwDYTi8wrXba3h5GGvtKiNLzRPKHmY29csiDU&amp;_nc_ht=scontent-icn1-1.xx&amp;oh=a432913b8ae9a6dc68a2a60be571764f&amp;oe=5DB7153D"></figcaption>
